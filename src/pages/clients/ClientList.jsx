...
const ClientList = () => {
  ...
  const fetchClients = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      const response = await clientService.getAll(activeFilters, 1, 50, forceRefresh);
  ...
  const loadMoreClients = useCallback(async () => {
    ...
    try {
      ...
      const response = await clientService.getAll(activeFilters, nextPage, 50);
          ...
          <div className="p-4">
            <div className="flex items-start">
              ...
              <p className="text-gray-800">
                No se pudo eliminar el cliente. {error.response?.data?.msg || 'Inténtelo de nuevo más tarde.'}
              </p>
            </div>
